...
class Photo extends ATransformableObject {
    ...
    const PATH_FACEBOOK = 'https://graph.facebook.com/';
    ...
    public function reThumbnail($x, $y, $width, $height) {
        ...
        $photoUploader->setThumbnail($this->getFullPath(self::SIZE_LARGE), $this->getFullPath(self::SIZE_SMALL), $x, $y, $width, $height, PhotoUploader::WIDTH_SMALL, PhotoUploader::HEIGHT_SMALL);
        $photoUploader->setThumbnail($this->getFullPath(self::SIZE_LARGE), $this->getFullPath(self::SIZE_MEDIUM), $x, $y, $width, $height, PhotoUploader::WIDTH_MEDIUM, PhotoUploader::HEIGHT_MEDIUM);
        return true;
    }
