  ...
  //  var eventSkeleton = eventList.find('li.LocationSkeleton').removeClass('LocationSkeleton').remove();
	...
	if ( response.comments.length > 0 ) {
	    ...
	    comment.removeClass('hide');
           // console.log(response.comments[0].message);
	...
	$('#FeaturedEvent_Markup').hover(
            function() { $(this).find('.FeaturedEventBottomBar').animate({ height: '48px' }, 150); },
            function() { $(this).find('.FeaturedEventBottomBar').animate({ height: '44px' }, 150); }
	);
    }
