LocationViewer = function(loc, date, userStatus) {
    ...
    function changeFollowTextOnHover() {
        $('.LocationLikeButton.active').mouseenter(function() {
            console.log($(this));
            $(this).text("Unfollow");
        }).mouseleave(function() {
            $(this).text("Following");
    ...
    function follow(button) {
       // mixpanel.track('follow click - live site', {'userId' : Viewer.userId});
        ...
        button.addClass('active').text("Following");
        changeFollowTextOnHover(button);
    }
    ...
    function init( ) {
        ...
        if (loc.userLikes) {
            ...
            changeFollowTextOnHover();
        }
        $('.LocationLikeNotLoggedIn').bind('click', function() {
            $('#myModal').modal('show');
